        ...
        <div className="flex-cont">
          ...
          <div className="two-nav">
            <ul className="top-nav">
              ...
              <li><NavLink to={"About Us"}>Abouts Us</NavLink></li>
            </ul>
          ...
          <div className="logos-flex-container">
            {/* <!-- fb yt twitter pinterest instagram -->
            <!-- <div className="web-logo">
              <svg  className="web-logo" xmlns="http://www.w3.org/2000/svg" width="20" height="20">
              <path
                fill="#FFF"
          ...
          <div className="copy_right">Copyright 2020. All Rights Reserved.</div>
        </div>
      </section>
    </>
  )
